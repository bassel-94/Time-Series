...
On the plot of the prices of crude oil  we added a blue line representing a moving average with basis 12. It has a very similar trajectory as the un-smoothed series. Fo the traveled miles data we can observe a clear seasonality with travel declining around February, in this case smoothing using moving averages has a greater impact allowing us to see the trend.
```{r}
par(mfrow=c(1,2))
ggplot(data2[data2$Type=="Diesel"|data2$Type=="Gasoline",])+
...
The next step of our analysis was to adjust the series for inflation. We had to do that in order to make the prices of different time periods comparable as inflation can induce a trend where there is actually none. The adjustment was done by dividing the price time series by the index of the CPI corresponding to each month. The basis for the adjustment was the month of April of 1994.
```{r}
...
## Yearly and Monthly Evolution for Inflation Adjusted Series
...
```{r} 
# The code needs to be re-done
data4$s_index<--1
data4$s_mean<--1
data4[data4$season=="winter"&data4$Type=="Miles",]$s_index<-1:nrow(data4[data4$season=="winter"&data4$Type=="Miles",])
data4[data4$season=="winter"&data4$Type=="Miles",]$s_mean<-mean(data4[data4$season=="winter"&data4$Type=="Miles","Value"])
i<-nrow(data4[data4$season=="winter"&data4$Type=="Miles",])
data4[data4$season=="spring"&data4$Type=="Miles",]$s_index<-(i+1):(i+nrow(data4[data4$season=="spring"&data4$Type=="Miles",]))
data4[data4$season=="spring"&data4$Type=="Miles",]$s_mean<-mean(data4[data4$season=="spring"&data4$Type=="Miles","Value"])
i<-nrow(data4[data4$season=="winter"&data4$Type=="Miles",])+nrow(data4[data4$season=="spring"&data4$Type=="Miles",])
data4[data4$season=="summer"&data4$Type=="Miles",]$s_index<-(i+1):(i+nrow(data4[data4$season=="summer"&data4$Type=="Miles",]))
data4[data4$season=="summer"&data4$Type=="Miles",]$s_mean<-mean(data4[data4$season=="summer"&data4$Type=="Miles","Value"])
i<-nrow(data4[data4$season=="winter"&data4$Type=="Miles",])+nrow(data4[data4$season=="spring"&data4$Type=="Miles",])+nrow(data4[data4$season=="summer"&data4$Type=="Miles",])
data4[data4$season=="autumn"&data4$Type=="Miles",]$s_index<-(i+1):(i+nrow(data4[data4$season=="autumn"&data4$Type=="Miles",]))
data4[data4$season=="autumn"&data4$Type=="Miles",]$s_mean<-mean(data4[data4$season=="autumn"&data4$Type=="Miles","Value"])
ggplot(data4[data4$Type=="Miles"&data4$Type=="Miles",])+
  aes(x=s_index,y=Value,colour=season)+
  geom_line()+
  geom_line(aes(x=s_index,y=s_mean,colour=season))+
  ggtitle("Monthly Miles Travelled")+
  xlab("Month")+
  ylab("Miles Travelled")
```