...
We can further understand the quality of the model by analising the distribution of the errors.

```{r pp, fig.align='center', fig.width=7, fig.height=5, echo = FALSE, warning=FALSE, fig.cap="Normal QQ plot of the errors"}
qqnorm(model$residuals)
```
...
```{r hy, fig.align='center', fig.width=12, fig.height=7, echo = FALSE, warning=FALSE, fig.cap="QQ norm plots and Shapiro test results"}
par(mfrow=c(1,3))
...
We can again observe that the outliers in the data affect the quality of the model by creating outliers in the errors too.
