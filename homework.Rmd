...
```{r, fig.align='center', fig.width=12, fig.height=7, echo = FALSE, warning=FALSE, fig.cap="LASSO VAR model on original vs differentiated time series"}
...
The plots above show an almost perfect fit for the gasoline prices and the Crude oil prices for both the differentiated and the original time series. Interestingly, the RA_Miles time series show an almost perfect fit for the differentiated (stationary) time series and a much worse fit when converting back to the original. 
